...
exports.cloudinarySecretKey = exports.cloudinaryApiKey = exports.cloudinaryCloudName = exports.secretKey = exports.nodeEnv = exports.mongoDbUrl = void 0;
const dotenv_1 = __importDefault(require("dotenv"));
dotenv_1.default.config();
const { MONGODB_URL, NODE_ENV, JWT_SECRET_KEY, CLOUDINARY_CLOUD_NAME, CLOUDINARY_API_KEY, CLOUDINARY_API_SECRET_KEY } = process.env;
if (!MONGODB_URL) {
